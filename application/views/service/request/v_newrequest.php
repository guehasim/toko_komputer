					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>ServiceRequest/tambah_request">
										...
										<div class="item form-group form-check">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="pelanggan" id="first-name" class="form-control" required>
											</div>
										</div>
										...
										<div class="item form-group form-check">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="rusak" id="first-name" class="form-control" required>
											</div>
										</div>
